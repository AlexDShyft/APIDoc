...
`;class tv{constructor(n){De(this,"mapping");this.mapping=n}getFor(n){return this.mapping.get(n.name)}}var ar;(function(i){i.UNION="union",i.ARGUMENT="argument",i.FIELD="field"})(ar||(ar={}));function iv(i){const n=new Map;return rv(i,t=>{yn(t)&&sv(t,s=>{const o=ga(s.type);aa(n,o).references.push({kind:ar.FIELD,parent:t,by:s}),ov(s,l=>{const p=ga(l.type);aa(n,p).references.push({kind:ar.ARGUMENT,field:s,type:t,by:l})})}),Kn(t)&&t.getTypes().forEach(s=>{aa(n,s).references.push({kind:ar.UNION,by:t})})}),new tv(n)}function rv(i,n){Object.entries(i.getTypeMap()).forEach(([,t])=>{t.name.startsWith("__")||n(t)})}function sv(i,n){Object.entries(i.getFields()).forEach(([,t])=>{n(t)})}function ov(i,n){Object.entries(i.args).forEach(([,t])=>{n(t)})}function aa(i,n){let t=i.get(n.name);return t||(t={references:[]},i.set(n.name,t)),t}function ga(i){return ln(i)||pi(i)?ga(i.ofType):i}const fn=Tv(),Ea=wa(ba.DIRECTIVES,[]);var Wc;const av=Os((Wc=fn.getQueryType())==null?void 0:Wc.getFields());var Yc;const uv=Os((Yc=fn.getMutationType())==null?void 0:Yc.getFields());var Qc;const lv=Os((Qc=fn.getSubscriptionType())==null?void 0:Qc.getFields()),ka=Ct.keyBy(Vf(),i=>i.name.toLocaleLowerCase()),cv=Ct.mapValues(ka,i=>{const n=Ea.find(t=>(t==null?void 0:t.name)===i.name||(t==null?void 0:t.name)==="*");return n?n.args.some(t=>t==="*")?i.args:n.args.map(t=>i.args.find(s=>s.name===t)).filter(t=>!!t):[]}),fv=Os(fn.getTypeMap()),pv=iv(fn);function Os(i){return Ct.mapKeys(i||{},(n,t)=>t.toLocaleLowerCase())}function dv(){return Ct.size(fn.getTypeMap())<=10}function hv(){return[ua("Queries",fn.getQueryType()),ua("Mutations",fn.getMutationType()),ua("Subscriptions",fn.getSubscriptionType()),Dv(),Ev()].filter(i=>!!i)}function ua(i,n){return gv(i,mv(n))}function mv(i){return Ct.sortBy((i==null?void 0:i.getFields())||{},n=>n.name)}function gv(i,n){return n.length===0?null:{type:"menu",title:i,children:n.map(t=>({type:"page",title:t.name,section:i,deprecated:!!t.deprecationReason,href:fr.joinUrlPaths(vs,i.toLocaleLowerCase(),t.name)}))}}function Ev(){return dv()?null:{type:"menu",title:"Types",children:Ct.sortBy(Ct.map(fn.getTypeMap()),n=>n.name).filter(n=>!n.name.startsWith("__")).map(n=>({type:"page",title:n.name,section:"Types",href:fr.joinUrlPaths(vs,"types",n.name)}))}}function Lv(){return!!fn.getQueryType()}function Bv(i){return av[i.toLocaleLowerCase()]}function Pv(){return!!fn.getMutationType()}function Uv(i){return uv[i.toLocaleLowerCase()]}function Mv(){return!!fn.getSubscriptionType()}function $v(i){return lv[i.toLocaleLowerCase()]}function Vv(i){return fv[i.toLocaleLowerCase()]}function yv(i){return ka[i.toLocaleLowerCase()]}function Gv(i){return yv(i.name)!==void 0}function jv(){return Ct.size(ka)>0}function qv(i){return cv[i.name.toLocaleLowerCase()]||[]}function Wv(i){if(i)return pv.getFor(i)}function Yv(i){return Ct.flatMap(i.getFields(),n=>({field:n,possibleDescriptions:$f(n,i)}))}function $f(i,n){return i?i.description?[{description:i.description,from:n}]:yn(n)?n.getInterfaces().flatMap(t=>$f(t.getFields()[i.name],t)):[]:[]}function Vf(){return Ea.some(i=>(i==null?void 0:i.name)==="*")?fn.getDirectives().filter(i=>!["include","skip","deprecated","specifiedBy"].includes(i.name)):Ea.filter(i=>!!(i!=null&&i.name)).map(({name:i})=>i?fn.getDirective(i):void 0).filter(i=>!!i)}function Tv(){return jc.trim().length===0?KI(JSON.parse(JSON.stringify({__schema:{types:[]}}))):nv(jc)}function Dv(){const i=Vf();return i.length===0?null:{type:"menu",title:"Directives",children:i.map(n=>({type:"page",title:n.name,href:fr.joinUrlPaths(vs,"directives",n.name),section:"Directives"}))}}const Qv=wa(ba.APP_TITLE,"GraphQL Documentation"),Gf=vv().concat(hv());Av(Gf);const Iv=Object.freeze(Gf),zv=_v();function vv(){return wa(ba.PAGES,wv()).filter(n=>!!n).map(n=>qf([],n))}function _v(){const i=bv();if(i)return i.href;throw new Error("No custom pages or query available to use as the root application URL. You need to provide at least one custom page or your schema should contain at least one query/mutation/subscription.")}function Av(i){function n(s,o){for(const u of s){if(u.type==="page"){o(u);continue}u.type==="menu"&&n(u.children,o)}}let t;n(i,s=>{t&&(t.next={title:s.title,section:s.section,href:s.href},s.previous={title:t.title,section:t.section,href:t.href}),t=s})}function bv(){return jf(()=>!0)}function Jv(i){return jf(n=>n.href.toLocaleLowerCase()===i.toLocaleLowerCase())}function jf(i){function n(t){for(const s of t){if(s.type==="page"&&i(s))return s;if(s.type==="menu"){const o=n(s.children);if(o)return o}}return null}return n(Iv)}function qf(i,n){if(typeof n.content=="string")return{type:"page",title:n.title,content:n.content,href:fr.joinUrlPaths(vs,...i,qc(n.title))};const t=i.concat([qc(n.title)]);return{type:"menu",title:n.title,children:n.content.map(s=>({...qf(t,s),section:n.title}))}}function qc(i){return fr.generatePathSegment(i,new tf)}function wv(){return[{title:"Introduction",content:[{title:"Welcome",content:`
        # Welcome 🎉
        ...
        `.split(`
`).map(i=>i.trim()).join(`
`)}]}]}export{Lv as A,tf as B,Bv as C,Mv as D,$v as E,oI as F,ln as G,pi as H,If as I,Df as J,Vv as K,Wv as L,Yv as M,Gv as N,_ as O,Rv as P,_s as Q,ar as R,Xc as S,kv as T,tr as U,aD as V,Ct as _,Ov as a,wa as b,Jn as c,yn as d,ct as e,cn as f,Jc as g,Jt as h,Zn as i,Kn as j,et as k,dv as l,Ie as m,Qv as n,xv as o,Iv as p,zv as q,Jv as r,fn as s,ba as t,fr as u,jv as v,yv as w,qv as x,Pv as y,Uv as z};

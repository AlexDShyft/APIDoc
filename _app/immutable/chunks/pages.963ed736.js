...
`;class n_{constructor(n){De(this,"mapping");this.mapping=n}getFor(n){return this.mapping.get(n.name)}}var ar;(function(i){i.UNION="union",i.ARGUMENT="argument",i.FIELD="field"})(ar||(ar={}));function t_(i){const n=new Map;return i_(i,t=>{yn(t)&&r_(t,s=>{const o=ga(s.type);aa(n,o).references.push({kind:ar.FIELD,parent:t,by:s}),s_(s,l=>{const p=ga(l.type);aa(n,p).references.push({kind:ar.ARGUMENT,field:s,type:t,by:l})})}),Kn(t)&&t.getTypes().forEach(s=>{aa(n,s).references.push({kind:ar.UNION,by:t})})}),new n_(n)}function i_(i,n){Object.entries(i.getTypeMap()).forEach(([,t])=>{t.name.startsWith("__")||n(t)})}function r_(i,n){Object.entries(i.getFields()).forEach(([,t])=>{n(t)})}function s_(i,n){Object.entries(i.args).forEach(([,t])=>{n(t)})}function aa(i,n){let t=i.get(n.name);return t||(t={references:[]},i.set(n.name,t)),t}function ga(i){return ln(i)||pi(i)?ga(i.ofType):i}const fn=y_(),Ea=Sa(ba.DIRECTIVES,[]);var Wc;const o_=ks((Wc=fn.getQueryType())==null?void 0:Wc.getFields());var Qc;const a_=ks((Qc=fn.getMutationType())==null?void 0:Qc.getFields());var zc;const u_=ks((zc=fn.getSubscriptionType())==null?void 0:zc.getFields()),Oa=Ct.keyBy(Vf(),i=>i.name.toLocaleLowerCase()),l_=Ct.mapValues(Oa,i=>{const n=Ea.find(t=>(t==null?void 0:t.name)===i.name||(t==null?void 0:t.name)==="*");return n?n.args.some(t=>t==="*")?i.args:n.args.map(t=>i.args.find(s=>s.name===t)).filter(t=>!!t):[]}),c_=ks(fn.getTypeMap()),f_=t_(fn);function ks(i){return Ct.mapKeys(i||{},(n,t)=>t.toLocaleLowerCase())}function p_(){return Ct.size(fn.getTypeMap())<=10}function d_(){return[ua("Queries",fn.getQueryType()),ua("Mutations",fn.getMutationType()),ua("Subscriptions",fn.getSubscriptionType()),T_(),g_()].filter(i=>!!i)}function ua(i,n){return m_(i,h_(n))}function h_(i){return Ct.sortBy((i==null?void 0:i.getFields())||{},n=>n.name)}function m_(i,n){return n.length===0?null:{type:"menu",title:i,children:n.map(t=>({type:"page",title:t.name,section:i,deprecated:!!t.deprecationReason,href:fr.joinUrlPaths(_s,i.toLocaleLowerCase(),t.name)}))}}function g_(){return p_()?null:{type:"menu",title:"Types",children:Ct.sortBy(Ct.map(fn.getTypeMap()),n=>n.name).filter(n=>!n.name.startsWith("__")).map(n=>({type:"page",title:n.name,section:"Types",href:fr.joinUrlPaths(_s,"types",n.name)}))}}function R_(){return!!fn.getQueryType()}function L_(i){return o_[i.toLocaleLowerCase()]}function B_(){return!!fn.getMutationType()}function P_(i){return a_[i.toLocaleLowerCase()]}function $_(){return!!fn.getSubscriptionType()}function U_(i){return u_[i.toLocaleLowerCase()]}function M_(i){return c_[i.toLocaleLowerCase()]}function E_(i){return Oa[i.toLocaleLowerCase()]}function V_(i){return E_(i.name)!==void 0}function j_(){return Ct.size(Oa)>0}function G_(i){return l_[i.name.toLocaleLowerCase()]||[]}function q_(i){if(i)return f_.getFor(i)}function W_(i){return Ct.flatMap(i.getFields(),n=>({field:n,possibleDescriptions:Mf(n,i)}))}function Mf(i,n){return i?i.description?[{description:i.description,from:n}]:yn(n)?n.getInterfaces().flatMap(t=>Mf(t.getFields()[i.name],t)):[]:[]}function Vf(){return Ea.some(i=>(i==null?void 0:i.name)==="*")?fn.getDirectives().filter(i=>!["include","skip","deprecated","specifiedBy"].includes(i.name)):Ea.filter(i=>!!(i!=null&&i.name)).map(({name:i})=>i?fn.getDirective(i):void 0).filter(i=>!!i)}function y_(){return Gc.trim().length===0?XI(JSON.parse(JSON.stringify({__schema:{types:[]}}))):e_(Gc)}function T_(){const i=Vf();return i.length===0?null:{type:"menu",title:"Directives",children:i.map(n=>({type:"page",title:n.name,href:fr.joinUrlPaths(_s,"directives",n.name),section:"Directives"}))}}const Q_=Sa(ba.APP_TITLE,"GraphQL Documentation"),jf=I_().concat(d_());v_(jf);const D_=Object.freeze(jf),z_=__();function I_(){return Sa(ba.PAGES,b_()).filter(n=>!!n).map(n=>qf([],n))}function __(){const i=A_();if(i)return i.href;throw new Error("No custom pages or query available to use as the root application URL. You need to provide at least one custom page or your schema should contain at least one query/mutation/subscription.")}function v_(i){function n(s,o){for(const u of s){if(u.type==="page"){o(u);continue}u.type==="menu"&&n(u.children,o)}}let t;n(i,s=>{t&&(t.next={title:s.title,section:s.section,href:s.href},s.previous={title:t.title,section:t.section,href:t.href}),t=s})}function A_(){return Gf(()=>!0)}function Y_(i){return Gf(n=>n.href.toLocaleLowerCase()===i.toLocaleLowerCase())}function Gf(i){function n(t){for(const s of t){if(s.type==="page"&&i(s))return s;if(s.type==="menu"){const o=n(s.children);if(o)return o}}return null}return n(D_)}function qf(i,n){if(typeof n.content=="string")return{type:"page",title:n.title,content:n.content,href:fr.joinUrlPaths(_s,...i,qc(n.title))};const t=i.concat([qc(n.title)]);return{type:"menu",title:n.title,children:n.content.map(s=>({...qf(t,s),section:n.title}))}}function qc(i){return fr.generatePathSegment(i,new tf)}function b_(){return[{title:"Introduction",content:[{title:"Welcome",content:`
        # Welcome 🎉
        ...
        `.split(`
`).map(i=>i.trim()).join(`
`)}]}]}export{R_ as A,tf as B,L_ as C,$_ as D,U_ as E,sI as F,ln as G,pi as H,If as I,Df as J,M_ as K,q_ as L,W_ as M,V_ as N,v as O,x_ as P,vs as Q,ar as R,Xc as S,k_ as T,tr as U,aD as V,Ct as _,C_ as a,Sa as b,Jn as c,yn as d,ct as e,cn as f,Jc as g,Jt as h,Zn as i,Kn as j,et as k,p_ as l,Ie as m,Q_ as n,O_ as o,D_ as p,z_ as q,Y_ as r,fn as s,ba as t,fr as u,j_ as v,E_ as w,G_ as x,B_ as y,P_ as z};
